...
const appCss = "/the-brain-songs/assets/styles-BC21gglT.css";
...
const $$splitComponentImporter$2 = () => import("./terms-D3a6G1_j.js");
const Route$3 = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Terms and Conditions governing your use of The Brain Song Reviews affiliate website."
    }, {
      property: "og:title",
      content: "Terms and Conditions — The Brain Song Reviews"
    }, {
      property: "og:description",
      content: "The rules for using The Brain Song Reviews website."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./privacy-t7PkcS2R.js");
const Route$2 = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Privacy Policy for The Brain Song Reviews affiliate website. Learn how we collect, use and protect your information."
    }, {
      property: "og:title",
      content: "Privacy Policy — The Brain Song Reviews"
    }, {
      property: "og:description",
      content: "How we handle your data on The Brain Song Reviews affiliate website."
    }]
  })
});
const $$splitComponentImporter = () => import("./disclaimer-D1ce6ncb.js");
const Route$1 = createFileRoute("/disclaimer")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Affiliate, medical, earnings, and content disclaimers for The Brain Song Reviews website."
    }, {
      property: "og:title",
      content: "Disclaimers — The Brain Song Reviews"
    }, {
      property: "og:description",
      content: "Important disclaimers regarding our reviews and affiliate links."
    }]
  })
});
function StickyBuyBar({ href }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-hidden": !visible,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-secondary border-t-4 border-primary shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col text-secondary-foreground leading-tight", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider opacity-80", children: "ProstaVive" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold text-lg", children: "Special Offer" })
        ] }),
...
function SectionTitle({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl md:text-5xl font-extrabold text-secondary text-center mb-8 leading-tight", children });
}
function Card({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card rounded-2xl p-6 sm:p-8 shadow-[var(--shadow-card)] border border-border/60", children });
}
function Index() {
  const benefits = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-background text-foreground pb-20 sm:pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyBuyBar, { href: BUY_URL }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 pt-12 pb-16 text-secondary-foreground", style: { backgroundImage: "var(--gradient-hero)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl md:text-6xl font-extrabold leading-[1.05]", children: [
          "Reclaim Your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Prostate Health" }),
          " Naturally"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-lg sm:text-xl text-secondary-foreground/90 max-w-xl", children: "ProstaVive supports healthy prostate function, improves urinary flow, and enhances overall vitality with clinically studied ingredients." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CTA, { label: "Get ProstaVive Today" }) })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: "/assets/bottles.png",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Why Choose ProstaVive?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-4", children: benefits.map((benefit, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "As Seen On" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center items-center gap-8 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-400", children: "CNN" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-400", children: "Fox News" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-400", children: "Health.com" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-400", children: "Men's Health" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { children: "Customer Reviews" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: testimonials.map((review, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-secondary", children: review.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: review.city }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary", children: "⭐⭐⭐⭐⭐" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground/80 italic", children: [
          '"',
          review.text,
          '"'
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-secondary text-secondary-foreground py-10 px-4 text-center text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-3xl mx-auto mb-4", children: "*These statements have not been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure, or prevent any disease." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-wrap justify-center gap-x-6 gap-y-2 mb-4 font-semibold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        " ProstaVive. All rights reserved."
      ] })
    ] })
  ] });
}
...
const DisclaimerRoute = Route$1.update({
  id: "/disclaimer",
  path: "/disclaimer",
  getParentRoute: () => Route$4
});
