...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BhHTM1-D.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dwyqt_TQ.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "the-brain-songs";
var SERVER_FN_BASE = "/the-brain-songs/_serverFn/";
